"""Structured JSONL audit trail for every write action a client asks for."""
import datetime
import json
import logging
...
_audit_handler = RotatingFileHandler(config.AUDIT_FILE, maxBytes=5 * 1024 * 1024, backupCount=3)
